            ...
            <div className="container">
                <div className="row footerMargin">
                    <ul className="col s12 center footerMargin">
                        <a href="https://github.com/hlarson0210/pullfirstpushlater" target="_blank" rel="noopener noreferrer"><img className="footerIcons" src="https://simpleicons.org/icons/github.svg" alt="github"></img></a>
